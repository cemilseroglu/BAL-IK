...
namespace BAL_IK.Data.Migrations
{
    ...
    [Migration("20220525104808_VardiyaTurDuzelnedi")]
    partial class VardiyaTurDuzelnedi
    {
            ...
            modelBuilder.Entity("BAL_IK.Model.Entities.SiteYoneticisi", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AktifMi = true,
                            Cinsiyet = 0,
                            DogumTarihi = new DateTime(2022, 5, 25, 13, 48, 8, 325, DateTimeKind.Local).AddTicks(2091),
